 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_a')){
	function azrcrv_create_plugin_menu_a(){
		azrcrv_create_plugin_menu_table_a();
		azrcrv_populate_plugin_menu_table_a();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_a')){
	function azrcrv_populate_plugin_menu_table_a(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_a')){
	function azrcrv_create_plugin_menu_table_a(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
