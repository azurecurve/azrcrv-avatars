...
### [Version 3.0.0](https://github.com/azurecurve/azrcrv-avatars/releases/tag/v3.0.0)
 * **BREAKING CHANGE MADE**: Resave Discussion Options page re-selecting the required default avatar.
 * Add direct access check to files.
 * Upgrade UpdateClient.
 * Update azurecurve plugins list.
 * Replace jquery with vanilla js.
 
### [Version 2.2.5](https://github.com/azurecurve/azrcrv-avatars/releases/tag/v2.2.5)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 2.2.4](https://github.com/azurecurve/azrcrv-avatars/releases/tag/v2.2.4)
 * Update plugin header and readme for compatibility with ClassicPress Directory v2.
 * Update Update Manager to version 2.5.0.
 
### [Version 2.2.3](https://github.com/azurecurve/azrcrv-avatars/releases/tag/v2.2.3)
